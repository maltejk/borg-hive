...
class CommandTest(TestCase):
    ...
    def test_run_authorized_keys_check(self):
        ...
        management.call_command(
            "authorized_keys_check", "--user", "6w9646gn", stdout=out
        )
    ...
    def test_run_authorized_keys_check_export(self):
        ...
        sys.stdout = out
        management.call_command(
            "authorized_keys_check", "--user", "7w9747gn", stdout=out
        )
    ...
    def test_run_authorized_keys_check_import(self):
        ...
        sys.stdout = out
        management.call_command(
            "authorized_keys_check", "--user", "8w9848gn", stdout=out
        )
    ...
    def test_run_authorized_keys_check(self):
        ...
        os.environ["DEBUG"] = "0"
        management.call_command(
            "watch_repositories", "--repo-path", ".", stdout=out
        )  # @TODO: blocking command
