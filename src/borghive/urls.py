...
from borghive.views import (
    ...
    SSHPublicKeyCreateView,
    SSHPublicKeyDeleteView,
...
urlpatterns = [
    path(
        "", RedirectView.as_view(url="repository/list", permanent=False), name="index"
    ),
    path("repository/list/", RepositoryListView.as_view(), name="repository-list"),
    path(
        "repository/detail/<int:pk>",
        RepositoryDetailView.as_view(),
        name="repository-detail",
    ),
    path(
        "repository/create/", RepositoryCreateView.as_view(), name="repository-create"
    ),
    path(
        "repository/delete/<int:pk>",
        RepositoryDeleteView.as_view(),
        name="repository-delete",
    ),
    path(
        "repository/update/<int:pk>",
    ...
    path(
        "notifications/list/", NotificationListView.as_view(), name="notification-list"
    ),
    path(
        "notifications/create/<str:n_type>",
